        ...
        <p className="inventory-item" onMouseOver={handleMouseOver} onMouseOut={handleMouseOut}>How to Play</p>
        {
            ...
            (isHovering)
                ? <div className="description-div">
                    ...
                    <p>{'> '}Problem solving</p>
                    <p>Your character needs to collect items and use them in the correct situations to progress through the game. Check item descriptions for clues by hovering your mouse over the items in your inventory. Look out for environmental clues too. If you are stuck, just go somewhere else. The right clue may be in another area. </p>
                </div>
                : <></>
        }
