    ...
    return <>
        <div className="about-div">
            <div className="about-text-div">
                ...
                <p className="about-text">"Think about Dot. Dot's a great pup, real loyal and all, but we seem to forget that she's got teeth that could tear you to shreds. She could do some serious damage if she wanted to.
                ...
                <p className="about-text">"Look I'm not trying to make you scared of Dot and I'm not saying you should skip school tomorrow. I'm just saying, you can do whatever the hell you want. You get one body, you get one life. They're both yours and yours alone."</p>
                <p className="about-text">...</p>
                <p className="about-text">"Make time. There's just not enough of it."</p>
            </div>
