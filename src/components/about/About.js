    ...
    return <>
        <div className="about-div">
            <div className="about-text-div">
                ...
                <p className="about-text">Something changes. Your vision fixes on the brown spot in the grass by your shoe. The back of your throat tastes like copper. The air gets heavy and hard to inhale. It feels like people are watching from the treeline.</p>
                ...
                <p className="about-text">"Think of Dot. Dot is a great pup, real loyal and all, but we seem to forget that she's got teeth that could tear you to shreds. She could do some serious damage if she wanted to.
                    And you know what else? We seem to forget that WE have teeth too."</p>
                <p className="about-text">He notices that his speech hasn't eased the worried look in your eye and softens his tone.</p>
                <p className="about-text">"Look I'm not trying to make you scared of Dot and I'm not saying you should skip school tomorrow. I'm just saying, you can do whatever the hell you want. You get one body, you get one life. They're both yours and yours alone. Make your own time."</p>
            </div>
